import { each, group, map, deepMap, index, find, filter, toClassName, toSingular, toForeignKeyName, toTableName, metadata, toUnderscored, toCamelCase, getMetadata } from "triframe/core"
...
let applicationMetadata, models;
...
export const sql = async (queryFragments, ...variables) => {
    ...
    const promise = database.query(parsed, escaped)
    escaped = []
